    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Container bearbeiten</h1>
                    <p class="text-gray-600 mt-1">Container-Informationen aktualisieren</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border-2 border-gray-200 overflow-hidden">
            ...
            <form wire:submit="save" class="p-6 space-y-6">
                ...
                <div class="flex items-center justify-end space-x-4 pt-6 border-t-2 border-gray-200">
                    ...
                    <button 
                        type="submit" 
                        class="px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors border-2 border-blue-600"
